...
public class A5Tester {
    ...
    public static void listTestOne() {
        ...
        System.out.println("Value at position 0: " + list.getAtPosition(0));
        displayResults(list.getAtPosition(0) == 15, "list get 5 element list");
        System.out.println("Value at position 1: " + list.getAtPosition(1));
        displayResults(list.getAtPosition(1) == 7, "list get 5 element list");
        System.out.println("Value at position 2: " + list.getAtPosition(2));
        displayResults(list.getAtPosition(2) == 4, "list get 5 element list");
        System.out.println("Value at position 3: " + list.getAtPosition(3));
        displayResults(list.getAtPosition(3) == 11, "list get 5 element list");
        System.out.println("Value at position 4: " + list.getAtPosition(4));
